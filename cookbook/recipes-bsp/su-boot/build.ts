...
import { getAssetPath } from "../../../../gaia/scripts/bitcook/utils/getAssetPath"
import { Recipe } from "../../../../gaia/scripts/bitcook/parse"
...
function compileBootScript (): void {
    logger.info("compiling synaptics boot script ...")
...
logger.info(`Building su-boot for ${MACHINE} :: ${ARCH} ...`)
